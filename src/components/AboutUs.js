  ...
  return (
    <div className="about-container">
      ...
      <p>
        ...
        portals. Our invincible expertise has raised our spirit to reach ahead
        from our client's expectation. Commendable success rate of other portals
        managed by Trippy is a live paradigm of our work excellence.
      </p>
